...
eos = input('1-PR 2-SRK ?');
n=input('enTer number of comPonenTs =   ');
for i=1:n   
 z(i)=input('enter overal composition for component  = ');
 
end
% z= [0.3448 0.1379 0.05517 0.04138 0.06896 0.04827 0.02758 0.1379 0.006897 0.06896 0.0007 0.062];
...
display('====================================================');
display('       mole fraction in phase_1  = ');
display('====================================================');
x

display('====================================================');
display('         mole fraction in phase_2  = ');
display('====================================================');
y
...
display('====================================================');
display('                liquid mole  nL = ');
display('====================================================');
nl

display('====================================================');
display('            k value for each component= ');
display('====================================================');
kvalue


display('====================================================');
display('         density for gas phase  pcf  = ');
display('====================================================');
rhovapor

display('====================================================');
display('         density for liquid phase  pcf ');
display('====================================================');
rholiquid

display('====================================================');
display('  gas liquid volume ratio GOR  GOR  ft3gas/ft3liq = ');
display('====================================================');
GOR
